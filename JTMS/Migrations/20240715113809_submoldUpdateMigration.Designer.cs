...
namespace JTMS.Migrations
{
    ...
    [Migration("20240715113809_submoldUpdateMigration")]
    partial class submoldUpdateMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JTMS.Models.MoldDetailsModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<bool?>("Process4Complete")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("JTMS.Models.MoldModel", b =>
                {
                    ...
                    b.Property<int>("Process1Count")
                        .HasColumnType("int");

                    b.Property<int>("Process2Count")
                        .HasColumnType("int");

                    b.Property<int>("Process3Count")
                        .HasColumnType("int");

                    b.Property<int>("Process4Count")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JTMS.Models.ProjectModel", b =>
                {
                    ...
                    b.Property<double>("PercentageCleared")
                        .HasColumnType("double");

                    b.Property<DateTime>("ProjectUpdateDate")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("JTMS.Models.ProjectNotesModels", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("JTMS.Models.ProjectNotifications", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");

                    b.Property<string>("NotificationT")
                        .IsRequired()
                        .HasColumnType("longtext");

                    b.Property<Guid>("SubMoldId")
                        .HasColumnType("char(36)");

                    b.HasKey("Id");

                    b.HasIndex("SubMoldId");
            ...
            modelBuilder.Entity("JTMS.Models.MoldDetailsModel", b =>
                {
                    b.HasOne("JTMS.Models.MoldModel", "Mold")
                        .WithMany()
            ...
            modelBuilder.Entity("JTMS.Models.ProjectNotifications", b =>
                {
                    b.HasOne("JTMS.Models.MoldDetailsModel", "SubMold")
                        .WithMany()
                        .HasForeignKey("SubMoldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SubMold");
                });
